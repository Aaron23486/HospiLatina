...
namespace HospiLatina.Controllers
{
    public class EstudiantesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdEstudiante,Nombre,Apellido,Especialidad,AnoDeGraduacion,HorarioAtencion")] Estudiante estudiante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEstudiante,Nombre,Apellido,Especialidad,AnoDeGraduacion,HorarioAtencion")] Estudiante estudiante)
        {
